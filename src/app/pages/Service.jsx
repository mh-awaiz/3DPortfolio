...
const Service = () => {
  return (
    <>
      <Head>
        <title>Services | Web Development by Mohammed Awaiz</title>
        <meta
          name="description"
          content="Offering custom websites, responsive design, and interactive user interfaces. Built with React, Next.js and modern tools."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Services - Mohammed Awaiz" />
        <meta
